  ...
  return <Container>
    <div style={{padding: '0 2rem'}}>
      ...
      <ul>
        ...
        <li>when game end and we start new game evething goes wrong</li>
        <li>when clear more then 1 row special block can not appers</li>
        <li>extand information about 404</li>
