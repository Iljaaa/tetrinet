    ...
    return <Container variant={'orange'}>
        ...
        <div className={styles.Help}>
            ...
            <div>
                ...
                <b>o</b> - Block Bomb - Only has an effect if the target's field has a Block Bomb special on it.Causes
                any blocks within a 3x3 radius of those specials to be scattered around their field
                <b>q</b> - Blockquake - Shifts the blocks on each row, often making a messier field and giving an
                earthquake effect.<br/>
                <b>g</b> - Block Gravity - Causes all blocks to pull down to the bottom of the field, and will remove
                any lines cleared as a result.<br/>
