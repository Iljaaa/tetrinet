        ...
        <div style={{padding: '0 2rem'}}>
            ...
            <div className={styles.Help}>
                ...
                <div>
                    ...
                    <b>o</b> - Block Bomb - Only has an effect if the target's field has a Block Bomb special on
                    it.Causes
                    ...
                    <b>g</b> - Block Gravity - Causes all blocks to pull down to the bottom of the field, and will
                    remove
