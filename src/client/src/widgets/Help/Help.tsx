...
export const Help = () => {
    return <div className={styles.Help}>
        ...
        <div>
            ...
            <b>o</b> - Block Bomb - Only has an effect if the target's field has a Block Bomb special on it.Causes any blocks within a 3x3 radius of those specials to be scattered around their field.<br/>
            ...
            // <b>m</b> - Mutate Pieces - Makes the target's X next pieces large and odd shaped, often forcing the target to make a messier field. Default = 3 next pieces<br/>
            <b>d</b> - Darkness - Turns the target's field black, hiding it from their view except for their current piece and a small window around it for X seconds. Default = 10 seconds<br/>
