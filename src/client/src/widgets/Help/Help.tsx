...
export const Help = () => {
    return <div className={styles.Help}>
        <div className={styles.ControlsColl}>
            ...
            <b>1-4</b> -apply bonus to opponent<br/>
        </div>
        <div>
            ...
            <b>o</b> - Block Bomb - Only has an effect if the target's field has a Block Bomb special on it.Causes any
            blocks within a 3x3 radius of those specials to be scattered around their field
            <br/>
            <div className={styles.Title}>In future:</div>.<br/>
            <b>q</b> - Blockquake - Shifts the blocks on each row, often making a messier field and giving an earthquake
            effect.<br/>
            <b>g</b> - Block Gravity - Causes all blocks to pull down to the bottom of the field, and will remove any
            lines cleared as a result.<br/>
            <b>s</b> - Switch Fields - Switches your field with the target's field.<br/>
            <b>n</b> - Nuke Field - Clears the entire field.<br/>
            // <b>i</b> - Immunity - Makes the target immune from being targetted by specials for X amount of seconds.
