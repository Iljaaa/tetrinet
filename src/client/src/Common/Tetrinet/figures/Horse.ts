 ...
 */
export abstract class Horse extends BaseFigure implements Figure
{
  ...
  constructor(cap:Cup, center:Coords)
  {
    ...
    const coords = this.getCoordsOfAllCellsByStateAndCenter(this._position, this.center)
   ...
   */
  abstract getCoordsOfAllCellsByStateAndCenter (state:number, center:Coords): Array<Coords>
